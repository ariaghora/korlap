...
const slate: ThemeDefinition = {
  ...
  css: {
    ...
    light: {
      ...
      "text-muted": "#9898a4",
      "text-dim": "#686878",
      "text-secondary": "#484858",
      "text-primary": "#1a1a22",
      "text-bright": "#08080e",
      "accent": "#3860a8",
      "status-ok": "#3a7a3a",
      "status-pr-open": "#3a60a0",
      "status-fail": "#b84040",
      "diff-add": "#3a7a3a",
      "diff-add-bg": "#daf0da",
      "diff-del": "#b84040",
      ...
      "error": "#b83838",
      "error-bg": "#f2dede",
      "toast-bg": "rgba(242, 242, 244, 0.85)",
      "toast-border": "rgba(0, 0, 0, 0.08)",
      "overlay-bg": "rgba(0, 0, 0, 0.3)",
      "input-inset-bg": "rgba(0, 0, 0, 0.05)",
      "input-inset-focus": "rgba(0, 0, 0, 0.08)",
      "btn-subtle-bg": "rgba(0, 0, 0, 0.05)",
      "btn-subtle-hover": "rgba(0, 0, 0, 0.1)",
      "pill-btn-hover": "rgba(0, 0, 0, 0.07)",
      "code-inline-bg": "rgba(0, 0, 0, 0.05)",
      "code-block-bg": "rgba(0, 0, 0, 0.07)",
      "img-remove-bg": "rgba(0, 0, 0, 0.6)",
      "img-remove-hover": "rgba(0, 0, 0, 0.8)",
      "bg-dev": "#dcdce8",
      "border-dev": "#b8b8cc",
    },
  },
  ...
  editor: {
    ...
    light: {
      ...
      link: "#3860a8",
      text: "#1a1a22",
      textSecondary: "#484858",
      textMuted: "#9898a4",
      bg: "#f2f2f4",
      bgCard: "#eaeaee",
      accentRgba: "56, 96, 168",
      borderColor: "#808090",
    },
  },
};
